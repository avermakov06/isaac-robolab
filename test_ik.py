...
while simulation_app.is_running():
    ...
    if world.is_playing():
        ...
        curr_joint_positions = [curr_joint_positions[i] for i in joint_indices]
        
        actions = my_controller.forward(
            picking_position=observations[task_params["sphere_name"]["value"]]["position"],
            placing_position=observations[task_params["sphere_name"]["value"]]["position"],
